...
export function OrderProvider({ children }: { children: ReactNode }) {
  ...
  // By generating the mock data inside useEffect, we ensure that `new Date()` and `Date.now()`
  // are only called on the client-side, preventing a mismatch with the server-rendered HTML.
  useEffect(() => {
