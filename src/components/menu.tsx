...
export function Menu({ items }: MenuProps) {
  ...
  return (
    <div className="min-h-screen w-full bg-muted/30 dark:bg-black">
        ...
        <div className="container mx-auto flex h-20 items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <Sheet open={isSheetOpen} onOpenChange={setIsSheetOpen}>
            <SheetTrigger asChild>
              <Button
                variant="outline"
                className="rounded-full h-12 w-auto p-4 shadow-lg text-base font-bold"
              >
                <ShoppingCart className="mr-3 h-5 w-5" />
                <span>{totalCartItems} Items</span>
                <Separator orientation="vertical" className="h-6 bg-border mx-4" />
              ...
              <div className="flex-grow overflow-y-auto -mx-6 px-6 py-4">
                {cart.length > 0 ? (
                  ...
                  <div className="flex flex-col items-center justify-center h-full text-center text-muted-foreground">
                    ...
                    <p>Start adding delicious items from the menu!</p>
                  </div>
                )}
              </div>
              {cart.length > 0 && (
      ...
      <main className="container mx-auto py-8 sm:py-12 px-4 sm:px-6 lg:px-8 pb-32">
